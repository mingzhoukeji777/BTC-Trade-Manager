...
public sealed class MainForm:Form
{
    ...
    static DataGridView Grid(){
        ...
        g.ColumnDividerDoubleClick += (sender,e)=>{ var dg=(DataGridView)sender!; if(e.ColumnIndex>=0){ dg.AutoResizeColumn(e.ColumnIndex,DataGridViewAutoSizeColumnMode.DisplayedCells); if(dg.Columns[e.ColumnIndex].Width>260) dg.Columns[e.ColumnIndex].Width=260; } };
        return g;
    }
